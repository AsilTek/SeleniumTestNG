...
public class TestBasedReport {
    ...
    public void setUpTest() {
        ...
        extentReports.attachReporter(extentHtmlReporter); //create report in or file

        // We can add all info we want to add
        extentReports.setSystemInfo("Enviroment","QA"); //add some extra info (not necessarily)
        extentReports.setSystemInfo("Browser", ConfigReader.getProperty("browser")); // chrome, firefox
        extentReports.setSystemInfo("Automation Engineer", "Akif"); //these are what you want to add report
    ...
    public void tearDownTest() {
        ...
        extentReports.flush(); //create our report after the test
    }
}
